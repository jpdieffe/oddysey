...
export const TOWER_CLASSES: readonly TowerClassInfo[] = [
  { key: 'paladin', name: 'Odysseus', glyph: '♞', accent: '#ffe27a' },
  { key: 'orc', name: 'Ajax', glyph: '⚔', accent: '#d28e5a' },
  { key: 'darkelf', name: 'Circe', glyph: '☾', accent: '#c08bff' },
  { key: 'highelf', name: 'Atalanta', glyph: '➶', accent: '#9fe3ff' },
  { key: 'magician', name: 'Polyphemus', glyph: '◉', accent: '#ff9a62' },
];
