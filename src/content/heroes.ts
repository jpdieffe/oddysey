...
export const HEROES: readonly HeroDef[] = [
  {
    ...
    key: 'paladin',
    name: 'Odysseus',
    title: 'The Cunning King of Ithaca',
    desc: 'A battle-tested spear fighter who wins by guile, grit, and perfect timing.',
    passiveName: 'Cunning Plan',
    passiveDesc: 'Enemies within 2 cells are slowed by 18% as he controls the fight.',
    ...
    ability: {
      ...
      name: 'Cyclops Breaker',
      desc: 'Drive the olive-wood spear down: heavy damage and a 1.2s stun nearby.',
  ...
  },
  {
    ...
    key: 'orc',
    name: 'Ajax',
    title: 'Great Shield of the Achaeans',
    desc: 'A towering champion whose enormous cleaves dominate a crowded road.',
    passiveName: 'Heroic Vigor',
    passiveDesc: 'Recovers health equal to 22% of all damage he deals.',
    ...
    ability: {
      kind: AbilityKind.ShieldSlam,
      name: 'Achaean Fury',
      desc: 'Sweep through everything nearby with a massive bronze blade.',
  ...
  },
  {
    ...
    desc: 'Cursed darts and transmuting magic unravel even the strongest monsters.',
    passiveName: 'Witch\'s Venom',
    ...
    ability: {
      ...
      name: 'Golden Loom',
      desc: 'Conjure an enchanted loom that fires on its own for 20 seconds.',
  ...
  },
  {
    ...
    key: 'high-elf',
    name: 'Atalanta',
    title: 'Fleet-Footed Huntress',
    desc: 'Lethal with a bow, she keeps every nearby defender firing faster.',
    passiveName: 'Hunter\'s Cadence',
    ...
    ability: {
      ...
      name: 'Artemis\' Volley',
      desc: 'Rain sacred arrows on a chosen area for 3.5 seconds.',
  ...
  },
  {
    ...
    key: 'magician',
    name: 'Polyphemus',
    title: 'The Cyclops Unbound',
    desc: 'A brutal close-range giant who can empower his fists with blazing boulder throws.',
    passiveName: 'Hephaestus\' Brand',
    passiveDesc: 'Attacks set targets alight for 8 damage/s over 2s.',
    hp: 215, hpPerLevel: 28, regen: 4,
    damage: 34, damagePerLevel: 9,
    attackCd: sec(0.95), range: fx(1.3), splash: fx(0.85),
    dmgType: DmgType.Physical, projSpeed: 0, projKind: ProjKind.HeroShot,
    moveSpeed: cps(2.6), respawn: sec(12),
    color: '#ff8a45',
    ability: {
      ...
      name: 'Etna\'s Wrath',
      desc: 'Call down a volcanic boulder: huge burst damage plus scorched ground.',
