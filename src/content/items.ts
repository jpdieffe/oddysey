...
export const RELICS: readonly RelicDef[] = [
  { id: 0, key: 'whetstone', name: 'Whetstone of Ares', icon: '⚔', cost: 260, maxStacks: 4,
    desc: '+10% damage from all of your towers.', mods: { damagePct: 10 } },
  { id: 1, key: 'lens', name: "Argus' Lens", icon: '🔭', cost: 240, maxStacks: 3,
    desc: '+12% range on all of your towers.', mods: { rangePct: 12 } },
  { id: 2, key: 'coil', name: "Hermes' Sandals", icon: '⚡', cost: 300, maxStacks: 3,
    desc: '+12% attack speed on all of your towers.', mods: { ratePct: 12 } },
  { id: 3, key: 'treasury', name: 'Trojan Spoils', icon: '💰', cost: 280, maxStacks: 3,
    desc: '+18% gold from every kill you make.', mods: { goldPct: 18 } },
  { id: 4, key: 'blueprint', name: "Daedalus' Plans", icon: '📐', cost: 250, maxStacks: 2,
    desc: 'Your upgrades cost 18% less.', mods: { upgradeDiscountPct: 18 } },
  { id: 5, key: 'cryo', name: 'Sigil of Boreas', icon: '❄', cost: 230, maxStacks: 2,
    desc: 'Your slows are 30% stronger and last 30% longer.', mods: { slowPct: 30 } },
  { id: 6, key: 'ember', name: 'Coal of Hephaestus', icon: '🔥', cost: 250, maxStacks: 3,
    desc: '+30% damage from your burns, blight and ground effects.', mods: { dotPct: 30 } },
  { id: 7, key: 'charm', name: "Athena's Favor", icon: '🦉', cost: 320, maxStacks: 2,
  ...
  { id: 9, key: 'battery', name: 'Nectar of Focus', icon: '🏺', cost: 240, maxStacks: 2,
  ...
  { id: 11, key: 'conduit', name: "Zeus' Conduit", icon: '🌩', cost: 300, maxStacks: 2,
...
export const ITEMS: readonly ItemDef[] = [
  item({
    id: ItemKind.Meteor, key: 'meteor', name: "Hephaestus' Fire", icon: '☄',
  ...
  item({
    id: ItemKind.FrostNova, key: 'frost-nova', name: "Boreas' Breath", icon: '❄',
  ...
  item({
    id: ItemKind.GoldCache, key: 'gold-cache', name: 'Trojan Treasure', icon: '💰',
    desc: 'Instantly gain 220 gold.',
    cost: 150, charges: 1, value: 220,
  }),
  item({
    id: ItemKind.RepairKit, key: 'repair-kit', name: 'Ambrosia Jar', icon: '🏺',
    desc: 'Restore 4 lives to the keep.',
    cost: 260, charges: 1, value: 4,
  }),
  item({
    id: ItemKind.TimeWarp, key: 'time-warp', name: "Aeolus' Windbag", icon: '⏳',
    desc: 'Slow every enemy on the map by 45% for 8 seconds.',
    cost: 190, charges: 2, duration: sec(8), slowPct: 45,
  }),
  item({
    id: ItemKind.TurretKit, key: 'turret-kit', name: 'Bronze Automaton', icon: '🔧',
