    ...
    el(
      ...
      el(
        ...
        el(
          ...
          { class: 'title' },
          el('h1', {}, 'ODYSSEY'),
          el('p', {}, 'Fight through gods and monsters. Find the long road home to Ithaca.'),
        ),
        ...
        el(
          ...
          el('div', {},
            el('div', { class: 'skill-kicker' }, 'THE VOYAGE HOME'),
            el('div', { class: 'campaign-reset-stage' }, `Book ${h.campaignStage + 1} of ${MAPS.length}`),
          ),
          tapButton('btn danger campaign-reset-button', h.onResetCampaign, 'Restart voyage'),
        ),
        el(
          'div',
      ...
      el(
        ...
        el(
          ...
          el('div', { class: 'btn-row', style: 'margin-top:12px' },
            ...
            tapButton('btn ghost', async () => {
              const shareData = { title: 'Odyssey', text: `Join my Odyssey voyage — code ${code}`, url: link };
              if (navigator.share) {
    ...
    el(
      ...
      el(
        ...
        el(
          ...
          el('h2', {}, 'The basics'),
          el('div', { class: 'muted' },
            'Monsters descend from the islands toward your ship. Every one that reaches it costs you lives. '
          ...
          el('h3', {}, 'Co-op rules'),
          el('div', { class: 'muted' },
            'You each have your own gold, powers, items, and companions, but you share the ship’s lives. '
