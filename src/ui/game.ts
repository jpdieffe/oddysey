    ...
    const panel = el(
      ...
      el(
        ...
        el(
          'div',
          { class: 'card' },
          el('h2', {}, cleared ? 'The passage is clear!' : 'The ship has fallen'),
        ...
        tapButton('btn primary', () => cleared ? this.opts.onAdvance() : this.opts.onRestart(), cleared ? 'Continue the voyage' : 'Try again'),
